...
<link  href="{{ asset('code/css/hover.css') }}" rel="stylesheet" />
  ...
  <script type="text/javascript">
    ...
    <div id="page-wrapper" style="background-image: url(code/img/body-bg.png);background-color: #eef1f4;">
       ...
       <?php
                    //$result = DB::table('checkin_and_out')->select('*')->get();
...
<form action="selectsingle"  method="post">
 {{csrf_field()}}
<!-- <input type="text" id="startDate" name="date" onselect="this.form.submit();"></input> -->
...
?>
<input type="text" id="startDate" name="date" value="<?php echo $date ?>"></input>
...
<?php
 ...
 updateConfig();
  ...
  $select12 = DB::table('checkin_and_out')->select('*')->where('checkin_date',$date)->where('email',$email)->get();
 ...
 -->        <td><?php echo $key->email;  ?></td>
    ...
    <td><b style="color:green;">Accepted</b></td>-->
      ...
      <?php
        ...
        //echo "no form submitted uptill now";
