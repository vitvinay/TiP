            ...
            <div class="navbar-default sidebar" role="navigation" style="background-color:#474e5d;">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#" style="color:#f2f2f2;"><i class="fa fa-users"></i> &nbsp; &nbsp; Employee Report<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                              
                                <li>
                                    <a href="alltimeemp" style="color:#f2f2f2;"><i class="fa fa-calendar-o"></i>&nbsp;&nbsp;All Employee</a>
                                </li>

								<li>
                                    <a href="Allftdateemp" style="color:#f2f2f2;" id=""><i class="fa fa-calendar"></i>&nbsp;&nbsp;Select Employee</a>
                                </li>
						...
						<li>
                            <a href="#" style="color:#f2f2f2;"><i class="fa fa-users"></i> &nbsp; &nbsp; Employee Leave Report<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Empleaveall" style="color:#f2f2f2;"><i class="fa fa-calendar-o"></i>&nbsp;&nbsp;All Employee</a>
                                </li>

								<li>
                                    <a href="Empleave" style="color:#f2f2f2;" id=""><i class="fa fa-calendar"></i>&nbsp;&nbsp;Select Employee</a>
                                </li>
						...
						<li>
                            <a href="#" style="color:#f2f2f2;"><i class="fa fa-users"></i> &nbsp; &nbsp; Client Report<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="allclient" style="color:#f2f2f2;"><i class="fa fa-calendar-o"></i>&nbsp;&nbsp;All Employee</a>
                                </li>

								<li>
                                    <a href="perclient" style="color:#f2f2f2;" id=""><i class="fa fa-calendar"></i>&nbsp;&nbsp;Select Employee</a>
                                </li>
						...
						<li>
                            <a href="#" style="color:#f2f2f2;"><i class="fa fa-users"></i> &nbsp; &nbsp; Client Leave Report<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="Leaveclient" style="color:#f2f2f2;"><i class="fa fa-calendar-o"></i>&nbsp;&nbsp;All Employee</a>
                                </li>

								<li>
                                    <a href="selectclient" style="color:#f2f2f2;" id=""><i class="fa fa-calendar"></i>&nbsp;&nbsp;Select Employee</a>
                                </li>
                        ...
                        <!--li>
                            <a href="#" style="color:#f2f2f2;"><i class="fa fa-user"></i>&nbsp;&nbsp;&nbsp;&nbsp;Select Employee<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
						<li class="sidebar-search">
                            <div class="input-group custom-search-form">
                                <input type="text" class="form-control" placeholder="Search...">
